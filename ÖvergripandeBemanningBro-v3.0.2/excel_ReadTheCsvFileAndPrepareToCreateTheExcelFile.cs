...
namespace ÖvergripandeBemanningBro_v3._0._2
{
    ...
    {
        public static Tuple<List<DateTime>,List<Personnel>,List<Personnel>, List<SchedItem>, List<SchedItem>> prepare(string fromFile, ToolStripStatusLabel toolStripStatusLabel1, ToolStripProgressBar toolStripProgressBar)
        {
            toolStripStatusLabel1.Text = "Vänta...";    
            ...
            List<Personnel> okListsOfPersonnelInSchedItems = SchedItem.collectDistincPersonnelFromSchedItemsWithoutContactingDatabase(okSchedItems);
            ...
            List<Personnel> notOkListsOfPersonnelInSchedItems = SchedItem.collectDistincPersonnelFromSchedItemsWithoutContactingDatabase(notOkSchedItems);
